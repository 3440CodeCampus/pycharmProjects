...
for num in range(100):
    ...
    print(f'{first} {last}\n{phone}\n{address}\n{email}\n')
'''
dock = list(range(1,53))
#random.shuffle(dock)
hand = random.sample(dock,k=5)
print (hand)
...
greetings=['hello','hi','hey','howdy','喂','怎麼啦']
valGreet = random.choice(greetings)
print (valGreet, "Arthur")
...
weightResult = random.choices(colors, weights=[18,18,2], k=10)
print (weightResult)
'''
